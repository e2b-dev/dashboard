  ...
  return (
    <>
      <DataTableRow
        ...
        className={cn(
          'group hover:bg-bg-hover border-b-0 focus:ring-ring focus:bg-bg-hover h-7 min-h-7 cursor-pointer gap-1.5 pl-1.5 truncate transition-none select-none even:bg-transparent focus:outline-none'
        )}

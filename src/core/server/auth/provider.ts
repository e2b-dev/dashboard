...
export interface AuthProvider {
  ...
  // Live profile lookup from Ory IdentityApi. Unlike getAuthContext's cheap
  // session path, this carries the full traits and credential-derived providers.
  // Heavier — call it once per dashboard load behind a cache, not on every request.

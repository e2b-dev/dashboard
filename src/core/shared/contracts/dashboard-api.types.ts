...
export interface components {
    ...
    parameters: {
        ...
        /** @description Sort column and direction. */
        templates_sort: "name_asc" | "name_desc" | "cpu_count_asc" | "cpu_count_desc" | "memory_mb_asc" | "memory_mb_desc" | "created_at_asc" | "created_at_desc" | "updated_at_asc" | "updated_at_desc";
        /** @description Identifier of the template. */
        templateID: string;
        /** @description Template tag name to check. */
        tag: string;

  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'bg-bg-1 prose-body fixed top-[180px] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] max-h-[calc(100svh-196px)] translate-x-[-50%] gap-4 overflow-y-auto border p-5 pt-4 duration-200 sm:max-w-lg',

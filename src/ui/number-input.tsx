    ...
    <div className={cn('flex items-center', className)}>
      <div className="flex flex-col">
        <Button
          ...
          size="icon"
          className={cn(
            'bg-bg-1 h-[1.125rem] rounded-none rounded-tl-md border-r-0 px-2 py-0',
            buttonClassName
          )}
          onClick={increment}
        ...
        <Button
          ...
          size="icon"
          className={cn(
            'bg-bg-1 h-[1.125rem] rounded-none rounded-bl-md border-t-0 border-r-0 px-2',
            buttonClassName
          )}
          onClick={decrement}
      ...
      <Input
        ...
        disabled={disabled}
        className={cn('bg-bg-1 h-9 w-min rounded-l-none', inputClassName)}
